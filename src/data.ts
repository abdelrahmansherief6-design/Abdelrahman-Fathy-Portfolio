...
export const defaultPortfolioData: PortfolioData = {
  "profile": {
    ...
    "phone": "+201000000000",
    "linkedin": "https://www.linkedin.com/in/abdelrahman-fathy-sherief",
    "location": {
      "en": "Giza, Egypt",
      "ar": "الجيزة، مصر"
    },
  ...
  "services": [
    {
      ...
      "items": [
        {
          "en": "Data Cleaning and Transformation",
          "ar": "تنظيف وتهيئة البيانات"
        },
        {
          "en": "Data Modeling",
          "ar": "نمذجة هيكل البيانات"
        },
        {
          "en": "KPI Development",
          "ar": "تطوير مؤشرات قياس الأداء"
        },
        {
          "en": "Business Performance Analysis",
          "ar": "تحليل أداء الأعمال والشركات"
        },
        {
        ...
        {
          "en": "ETL Process Design",
          "ar": "تصميم عمليات استخراج وتحويل البيانات (ETL)"
        }
      ]
    },
    {
      ...
      "items": [
        {
          ...
          "ar": "لوحات قيادة Power BI تفاعلية"
        },
        {
          "en": "Executive Dashboards",
          "ar": "لوحات قيادة للمدراء والتنفيذيين"
        },
        {
          "en": "Operational Dashboards",
          "ar": "لوحات قيادة لمراقبة التشغيل اليومي"
        },
        {
          "en": "Quality Dashboards",
          "ar": "لوحات قيادة مخصصة لإدارة الجودة"
        },
        {
          "en": "Automated Reporting Solutions",
          "ar": "حلول التقارير الدورية المؤتمتة"
        }
      ]
    },
    {
      ...
      "items": [
        {
          "en": "Power Automate Workflows",
          "ar": "سير عمل مؤتمت عبر Power Automate"
        },
        {
          "en": "AppSheet Business Applications",
          "ar": "تطبيقات أعمال مخصصة باستخدام AppSheet"
        },
        {
          "en": "Approval Systems",
          "ar": "أنظمة الموافقات الإلكترونية المؤتمتة"
        },
        {
          "en": "Notification Systems",
          "ar": "أنظمة التنبيهات والإشعارات الفورية"
        },
        {
          "en": "Data Collection Solutions",
          "ar": "حلول تجميع البيانات الميدانية والتشغيلية"
        }
      ]
    },
    {
      ...
      "items": [
        {
          "en": "Customer Complaints Analysis",
          "ar": "تحليل شكاوى وبلاغات العملاء"
        },
        {
          "en": "Root Cause Analysis",
          "ar": "تحليل الأسباب الجذرية للمشكلات (RCA)"
        },
        {
          "en": "Non-Conformity Reporting",
          "ar": "تقارير ونماذج حالات عدم المطابقة"
        },
        {
          "en": "Quality KPI Monitoring",
          "ar": "متابعة مؤشرات أداء الجودة في خطوط الإنتاج"
        },
        {
          "en": "Reliability Testing Analytics",
          "ar": "تحليلات واختبارات الموثوقية للمنتجات"
        },
        {
          "en": "Manufacturing Performance Analysis",
          "ar": "تحليل كفاءة وأداء العمليات التصنيعية"
        }
      ]
    }
  ],
  ...
  "projects": [
    {
      ...
      "metrics": [
        {
          "label": {
            "en": "NCR Response Speed",
            "ar": "سرعة الاستجابة للمشكلات"
          },
          "value": "+60%"
        },
        {
          "label": {
            "en": "Defect Rate Reduction",
            "ar": "تقليل معدل العيوب"
          },
          "value": "-18%"
        },
        {
          "label": {
            "en": "Audit-Ready Tracking",
            "ar": "تتبع فوري للتدقيق"
          },
          "value": "100%"
        }
      ],
    ...
    },
    {
      ...
      "metrics": [
        {
          "label": {
            "en": "Manual Inspection Time",
            "ar": "وقت الفحص اليدوي الموفر"
          },
          "value": "-40hr/mo"
        },
        {
          "label": {
            "en": "Missed Test Failures",
            "ar": "أعطال اختبارات لم تُرصد"
          },
          "value": "0"
        },
        {
          "label": {
            "en": "Feedback Loop Speed",
            "ar": "سرعة إرسال الملاحظات"
          },
          "value": "+85%"
        }
      ],
    ...
    },
    {
      ...
      "metrics": [
        ...
        {
          "label": {
            "en": "Warranty Claims Saved",
            "ar": "وفر تكاليف الضمان"
          },
          "value": "$40,000+"
        },
        {
      ...
      "metrics": [
        {
          "label": {
            "en": "Manual Reports",
            "ar": "تقارير يدوية ملغاة"
          },
          "value": "100%"
        },
        {
          "label": {
            "en": "Analyst Hours Saved",
            "ar": "ساعات عمل المحللين الموفرة"
          },
          "value": "20+ hr/wk"
        },
        {
          "label": {
            "en": "Demand Forecast Accuracy",
            "ar": "دقة التنبؤ بالطلب"
          },
          "value": "94%"
        }
      ],
    ...
    },
    {
      ...
      "metrics": [
        {
          "label": {
            "en": "Ledger Discrepancies",
            "ar": "أخطاء وفروقات الخزينة"
          },
          "value": "0%"
        },
        {
          "label": {
            "en": "Inventory Audit Duration",
            "ar": "مدة جرد المخزون"
          },
          "value": "2d → 3hr"
        },
  ...
  "stats": [
    ...
    },
    {
      ...
      "label": {
        "en": "Lab Utilization (from 70%)",
        "ar": "استغلال المختبرات (من 70%)"
      },
      "iconName": "TrendingUp"
    },
    {
    ...
    },
    {
      ...
      "label": {
        "en": "Digital Shop floor Adoption",
        "ar": "الاعتماد الرقمي للعمال"
      },
      "iconName": "Database"
    }
  ]
